...
<!-- benchmark -->
This is the summary of the tests performed with the TOTAL set to 10000000, at 2024-07-05 16:56, on Linux, with 4 CPUs:

| | Before | After | Diff |
| --- | --: | --: | --: |
| Time, msec (with JIT, ×40 cycles) | 4765 | 3799 | -20% |
| Time, msec (no JIT) | 5660 | 2676 | -52% |
| Total `.class` files | 3 | 4 | |
| Bytes in all `.class` files | 8010 | 7300 | |
| JAR file size, bytes | 49724094 | 43105898 | |
