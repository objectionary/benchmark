...
<!-- benchmark -->
This is the summary of the tests performed with the TOTAL set to 1000000, at 2024-02-06 14:23, on Linux, with 4 CPUs:

| | Before | After | Diff |
| --- | --: | --: | --: |
| Time, msec (with JIT, ×40 cycles) | 2120 | 1437 | -32% |
| Time, msec (no JIT) | 2242 | 967 | -56% |
